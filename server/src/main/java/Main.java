...
//        DBProvider.establishConnection("jdbc:postgresql://pg:5432/studs", "s389871", "NZgIf8KuvcTcLIZu");
...
//       Строчки для теста на локалхосте. Для гелиуса достаточно указать только порт
        DBProvider.establishConnection("jdbc:postgresql://localhost:9999/studs", "s389871", "NZgIf8KuvcTcLIZu");
